...
import { Leaf, XCircle, AlertTriangle, ShieldCheck, ShieldAlert, CloudRain, Sun, CloudDrizzle, HelpCircle, Download } from "lucide-react";
...
const CLIMATE_META: Record<string, { label: string; color: string; icon: React.ElementType }> = {
    ...
    <div className={`mt-6 p-5 rounded-lg border ${RISK_COLORS[result.riskLevel]}`}>
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center mb-4">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 text-sm font-medium border border-current px-4 py-2 rounded-md hover:bg-white/50 transition"
        >
